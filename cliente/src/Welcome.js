...
// Cargar las texturas previamente
const textureLoader = new TextureLoader();
const paredTexture = textureLoader.load("/static/Wall/Wood_Wall_002_SD/Wood_Wall_002_basecolor.jpg");
const pisoTexture = textureLoader.load("/static/Floor/Tatami_001_SD/Tatami_001_basecolor.jpg");
const puertaTexture = textureLoader.load("/static/Wall/Wood_Wall_002_SD/Wood_Door_002_basecolor.jpg");
const techoTexture = textureLoader.load("/static/Wall/Wood_Wall_002_SD/Stylized_Thatched_Roof_002_basecolor.jpg");
  ...
  return (
    <group>
      <mesh position-y={0} position-x={resize} rotation-x={- Math.PI * 0.5} >
        ...
        <meshStandardMaterial map={pisoTexture} />
      </mesh>
      <mesh position-y={resize / 2} position-x={resize} rotation-x={- Math.PI * 0.5} >
        <boxGeometry args={[resize * 3, resize, 0.01]} />
        <meshStandardMaterial map={techoTexture} />
      </mesh>
